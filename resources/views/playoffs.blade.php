...
<body>
    <h1>Estadísticas jugadores playoffs 2026</h1>
    ...
    <p class="sample-warning">
        ⚠️ Las estadísticas avanzadas (TS%, USG%, OFF Rating, DEF Rating y NET Rating)pueden resultar engañosas
        en
        jugadores con
        muestras pequeñas de partidos o minutos jugados, especialmente en suplentes.
    </p>
    <h4>Solo aparecen los equipos clasificados a playoffs en 2026.</h4>
</body>
